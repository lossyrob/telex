...
**sessionEnd removal proof** (no external registry; explicit membership via `Detach`/`Ack`; was "DeregisterSession proof"), the Status freeze line, and crash durability — are resolved in
