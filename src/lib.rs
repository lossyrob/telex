...
pub mod daemon;
pub mod daemon_ipc;
/// Daemon-owned station-intent reconciliation (ADR 0052). Physically `src/daemon_reconcile.rs`,
...
pub mod model;
pub mod output;
/// Shared owner-private filesystem and process-identity primitives (see ADR 0025, ADR 0052).
pub mod platform_fs;
pub mod profiles;
